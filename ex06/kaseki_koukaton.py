...
class Object:
    ...
    def gold(self,image,size,pos):
        self.gold_img_sfc = pg.image.load(image)
        self.gold_img_sfc = pg.transform.rotozoom(self.gold_img_sfc,0,size)
        self.gold_img_rct = self.gold_img_sfc.get_rect()
        self.gold_img_rct.center = pos
    
    def drill(self,image,size,pos):
        self.drill_img_sfc = pg.image.load(image)
        self.drill_img_sfc = pg.transform.rotozoom(self.drill_img_sfc,0,size)
        self.drill_img_rct = self.drill_img_sfc.get_rect()
        self.drill_img_rct.center = pos
    ...
    def bilt(self,dis:Display):
        ...
        dis.sfc.blit(self.gold_img_sfc, self.gold_img_rct)
        dis.sfc.blit(self.drill_img_sfc, self.drill_img_rct)
...
def main():
    ...
    obj.gold("fig/goldkokaton.jpg", 0.5,(random.randint(70,gbn.kiban_sfc.get_width()-50), random.randint(70,gbn.kiban_sfc.get_height()-50)))
    obj.drill("fig/D.jpg",0.2,  (1450,100))
    obj.hanma("fig/hanma.png",0.2, (1200, 100))
    while True:
